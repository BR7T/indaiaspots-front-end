        ...
        <header className="shadow-sm gap-2">
            ...
            {   
                ...
                isLoggedIn ? (
                    ...
                    <div id="dropdownInformation" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-2/12 dark:bg-gray-700 dark:divide-gray-600">
                        <div className="px-4 py-3 text-sm text-gray-900 dark:text-white hover:bg-gray-100 cursor-pointer select-none" >
                            <div>{username}</div>
                        ...
                        <div className="py-2">
                        <button className="w-full text-red-500 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onClick={()=>{logout().then(res=>window.location.href = '/login')}}>Sign out</button>
                        </div>
                    </div>
</>
                ) :
